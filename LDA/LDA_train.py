# -*- coding: utf-8 -*-
"""
Created on Sat Apr 14 00:17:14 2018
...
temp_x, waste_x = train_test_split(test_data, test_size=0.5, random_state=42)
test_data = temp_x
...
plt.title('Scatter plot of first two features after Dimensionality reduction by LDA')
plt.savefig('LDA.png')                     
plt.show()
